...
if [[ "$LFS_VERSION" == "12.3" ]] || [[ "$LFS_VERSION" == "12.4" ]] || [[ "$LFS_VERSION" == "13.0" ]] && [[ "$LFSINIT" == "systemd" ]]; then
	./configure --prefix=/usr                            \
				--docdir=/usr/share/doc/procps-ng-$PROCPS_VERSION  \
				--disable-static                         \
				--disable-kill                          \
...
if [[ "$LFS_VERSION" == "12.2" ]] || [[ "$LFS_VERSION" == "12.3" ]] || [[ "$LFS_VERSION" == "12.4" ]] || [[ "$LFS_VERSION" == "13.0" ]] && $RUN_TESTS; then
    set +e
    chown -R tester .
